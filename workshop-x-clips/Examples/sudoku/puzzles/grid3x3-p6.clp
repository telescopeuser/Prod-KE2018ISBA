...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 2) (value 7) (group 1) (id 2)))
   ...
   (assert (possible (row 3) (column 4) (value 6) (group 2) (id 16)))
   ...
   (assert (possible (row 4) (column 1) (value 8) (group 4) (id 28)))
   ...
   (assert (possible (row 5) (column 2) (value 3) (group 4) (id 32)))
   (assert (possible (row 5) (column 3) (value 4) (group 4) (id 33)))
   (assert (possible (row 6) (column 1) (value 5) (group 4) (id 34)))
   (assert (possible (row 6) (column 2) (value any) (group 4) (id 35)))
   (assert (possible (row 6) (column 3) (value any) (group 4) (id 36)))   
   
   (assert (possible (row 4) (column 4) (value 1) (group 5) (id 37)))
   ...
   (assert (possible (row 6) (column 6) (value 6) (group 5) (id 45)))

   (assert (possible (row 4) (column 7) (value any) (group 6) (id 46)))
   (assert (possible (row 4) (column 8) (value any) (group 6) (id 47)))
   (assert (possible (row 4) (column 9) (value 4) (group 6) (id 48)))
   (assert (possible (row 5) (column 7) (value 2) (group 6) (id 49)))
   ...
   (assert (possible (row 8) (column 3) (value 2) (group 7) (id 60)))
   ...
   (assert (possible (row 7) (column 6) (value 5) (group 8) (id 66)))
   ...
   (assert (possible (row 9) (column 8) (value 4) (group 9) (id 80)))
