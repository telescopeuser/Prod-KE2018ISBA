...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 8) (value 5) (group 3) (id 20)))
   (assert (possible (row 1) (column 9) (value 4) (group 3) (id 21)))
   (assert (possible (row 2) (column 7) (value 6) (group 3) (id 22)))
   ...
   (assert (possible (row 5) (column 1) (value 3) (group 4) (id 31)))
   (assert (possible (row 5) (column 2) (value any) (group 4) (id 32)))
   (assert (possible (row 5) (column 3) (value 7) (group 4) (id 33)))
   (assert (possible (row 6) (column 1) (value any) (group 4) (id 34)))
   (assert (possible (row 6) (column 2) (value 5) (group 4) (id 35)))
   ...
   (assert (possible (row 4) (column 6) (value 1) (group 5) (id 39)))
   ...
   (assert (possible (row 6) (column 4) (value 4) (group 5) (id 43)))
   ...
   (assert (possible (row 5) (column 7) (value 4) (group 6) (id 49)))
   (assert (possible (row 5) (column 8) (value any) (group 6) (id 50)))
   (assert (possible (row 5) (column 9) (value 8) (group 6) (id 51)))
   ...
   (assert (possible (row 8) (column 3) (value 1) (group 7) (id 60)))
   (assert (possible (row 9) (column 1) (value 9) (group 7) (id 61)))
   (assert (possible (row 9) (column 2) (value 2) (group 7) (id 62)))
