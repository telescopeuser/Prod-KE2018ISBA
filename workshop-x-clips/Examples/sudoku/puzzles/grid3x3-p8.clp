...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 2) (value 3) (group 1) (id 2)))
   (assert (possible (row 1) (column 3) (value any) (group 1) (id 3)))
   (assert (possible (row 2) (column 1) (value 4) (group 1) (id 4)))
   ...
   (assert (possible (row 1) (column 6) (value 6) (group 2) (id 12)))
   ...
   (assert (possible (row 6) (column 2) (value 1) (group 4) (id 35)))
   (assert (possible (row 6) (column 3) (value any) (group 4) (id 36)))   
   
   (assert (possible (row 4) (column 4) (value 2) (group 5) (id 37)))
   ...
   (assert (possible (row 6) (column 6) (value 3) (group 5) (id 45)))

   (assert (possible (row 4) (column 7) (value any) (group 6) (id 46)))
   (assert (possible (row 4) (column 8) (value 1) (group 6) (id 47)))
   ...
   (assert (possible (row 7) (column 3) (value 6) (group 7) (id 57)))
   ...
   (assert (possible (row 7) (column 5) (value 8) (group 8) (id 65)))
   (assert (possible (row 7) (column 6) (value any) (group 8) (id 66)))
   (assert (possible (row 8) (column 4) (value 4) (group 8) (id 67)))
   ...
   (assert (possible (row 8) (column 9) (value 3) (group 9) (id 78)))
   (assert (possible (row 9) (column 7) (value any) (group 9) (id 79)))
   (assert (possible (row 9) (column 8) (value 7) (group 9) (id 80)))
   (assert (possible (row 9) (column 9) (value 8) (group 9) (id 81))))   
