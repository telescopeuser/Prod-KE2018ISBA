...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 1) (value 9) (group 1) (id 1)))
   ...
   (assert (possible (row 3) (column 2) (value 4) (group 1) (id 8)))
   ...
   (assert (possible (row 2) (column 4) (value 1) (group 2) (id 13)))
   (assert (possible (row 2) (column 5) (value 7) (group 2) (id 14)))
   ...
   (assert (possible (row 4) (column 2) (value 9) (group 4) (id 29)))
   ...
   (assert (possible (row 4) (column 9) (value 1) (group 6) (id 48)))
   ...
   (assert (possible (row 6) (column 8) (value 4) (group 6) (id 53)))
   ...
   (assert (possible (row 8) (column 6) (value 5) (group 8) (id 69)))
   (assert (possible (row 9) (column 4) (value any) (group 8) (id 70)))
   (assert (possible (row 9) (column 5) (value any) (group 8) (id 71)))
   (assert (possible (row 9) (column 6) (value 3) (group 8) (id 72)))

   (assert (possible (row 7) (column 7) (value any) (group 9) (id 73)))
   (assert (possible (row 7) (column 8) (value 8) (group 9) (id 74)))
   (assert (possible (row 7) (column 9) (value any) (group 9) (id 75)))
   (assert (possible (row 8) (column 7) (value 4) (group 9) (id 76)))
   (assert (possible (row 8) (column 8) (value 1) (group 9) (id 77)))
