...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 3) (value 3) (group 1) (id 3)))
   (assert (possible (row 2) (column 1) (value 9) (group 1) (id 4)))
   ...
   (assert (possible (row 3) (column 2) (value 2) (group 1) (id 8)))
   ...
   (assert (possible (row 2) (column 4) (value 3) (group 2) (id 13)))
   ...
   (assert (possible (row 2) (column 7) (value 4) (group 3) (id 22)))
   ...
   (assert (possible (row 5) (column 4) (value 4) (group 5) (id 40)))
   (assert (possible (row 5) (column 5) (value 7) (group 5) (id 41)))
   ...
   (assert (possible (row 7) (column 1) (value 6) (group 7) (id 55)))
   ...
   (assert (possible (row 7) (column 4) (value 7) (group 8) (id 64)))
   ...
   (assert (possible (row 8) (column 6) (value 1) (group 8) (id 69)))
   ...
   (assert (possible (row 9) (column 7) (value 2) (group 9) (id 79)))
