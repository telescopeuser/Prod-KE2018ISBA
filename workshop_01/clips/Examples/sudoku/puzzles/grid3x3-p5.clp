...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 4) (value 9) (group 2) (id 10)))
   ...
   (assert (possible (row 1) (column 9) (value 5) (group 3) (id 21)))
   ...
   (assert (possible (row 4) (column 3) (value 9) (group 4) (id 30)))
   (assert (possible (row 5) (column 1) (value 2) (group 4) (id 31)))
   ...
   (assert (possible (row 6) (column 4) (value 5) (group 5) (id 43)))
   (assert (possible (row 6) (column 5) (value 9) (group 5) (id 44)))
   ...
   (assert (possible (row 7) (column 1) (value 8) (group 7) (id 55)))
