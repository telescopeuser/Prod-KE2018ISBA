...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 3) (value 4) (group 1) (id 3)))
   ...
   (assert (possible (row 1) (column 5) (value 6) (group 2) (id 11)))
   (assert (possible (row 1) (column 6) (value 2) (group 2) (id 12)))
   ...
   (assert (possible (row 3) (column 4) (value 4) (group 2) (id 16)))
   ...
   (assert (possible (row 2) (column 8) (value 2) (group 3) (id 23)))
   ...
   (assert (possible (row 4) (column 1) (value 3) (group 4) (id 28)))
   ...
   (assert (possible (row 5) (column 2) (value 7) (group 4) (id 32)))
   ...
   (assert (possible (row 6) (column 3) (value 1) (group 4) (id 36)))   
   ...
   (assert (possible (row 5) (column 8) (value 3) (group 6) (id 50)))
   ...
   (assert (possible (row 8) (column 2) (value 2) (group 7) (id 59)))
   ...
   (assert (possible (row 9) (column 3) (value 6) (group 7) (id 63)))   
   
   (assert (possible (row 7) (column 4) (value any) (group 8) (id 64)))
   (assert (possible (row 7) (column 5) (value any) (group 8) (id 65)))
   (assert (possible (row 7) (column 6) (value 7) (group 8) (id 66)))
   (assert (possible (row 8) (column 4) (value any) (group 8) (id 67)))
   (assert (possible (row 8) (column 5) (value 9) (group 8) (id 68)))
   (assert (possible (row 8) (column 6) (value any) (group 8) (id 69)))
   (assert (possible (row 9) (column 4) (value 2) (group 8) (id 70)))
   (assert (possible (row 9) (column 5) (value 3) (group 8) (id 71)))
   ...
   (assert (possible (row 8) (column 8) (value 8) (group 9) (id 77)))
   (assert (possible (row 8) (column 9) (value any) (group 9) (id 78)))
   (assert (possible (row 9) (column 7) (value 1) (group 9) (id 79)))
