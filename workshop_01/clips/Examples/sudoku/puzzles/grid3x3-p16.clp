...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 1) (value 2) (group 1) (id 1)))
   ...
   (assert (possible (row 3) (column 2) (value 7) (group 1) (id 8)))
   ...
   (assert (possible (row 5) (column 3) (value 5) (group 4) (id 33)))
   (assert (possible (row 6) (column 1) (value 8) (group 4) (id 34)))
   (assert (possible (row 6) (column 2) (value 2) (group 4) (id 35)))
   ...
   (assert (possible (row 4) (column 6) (value 7) (group 5) (id 39)))
   ...
   (assert (possible (row 6) (column 4) (value 3) (group 5) (id 43)))
   ...
   (assert (possible (row 4) (column 8) (value 8) (group 6) (id 47)))
   (assert (possible (row 4) (column 9) (value 6) (group 6) (id 48)))
   (assert (possible (row 5) (column 7) (value 9) (group 6) (id 49)))
   ...
   (assert (possible (row 9) (column 9) (value 5) (group 9) (id 81))))   
