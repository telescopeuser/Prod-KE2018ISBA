...
(defrule grid-values
   ...
   (assert (possible (row 2) (column 1) (value 5) (group 1) (id 4)))
   ...
   (assert (possible (row 3) (column 2) (value 9) (group 1) (id 8)))
   ...
   (assert (possible (row 2) (column 5) (value 1) (group 2) (id 14)))
   (assert (possible (row 2) (column 6) (value 8) (group 2) (id 15)))
   (assert (possible (row 3) (column 4) (value any) (group 2) (id 16)))
   (assert (possible (row 3) (column 5) (value any) (group 2) (id 17)))
   (assert (possible (row 3) (column 6) (value 2) (group 2) (id 18)))

   (assert (possible (row 1) (column 7) (value any) (group 3) (id 19)))
   (assert (possible (row 1) (column 8) (value 7) (group 3) (id 20)))
   ...
   (assert (possible (row 3) (column 8) (value 6) (group 3) (id 26)))
   (assert (possible (row 3) (column 9) (value any) (group 3) (id 27)))   

   (assert (possible (row 4) (column 1) (value 7) (group 4) (id 28)))
   ...
   (assert (possible (row 5) (column 2) (value 2) (group 4) (id 32)))
   (assert (possible (row 5) (column 3) (value 6) (group 4) (id 33)))
   ...
   (assert (possible (row 4) (column 6) (value 3) (group 5) (id 39)))
   ...
   (assert (possible (row 5) (column 7) (value 3) (group 6) (id 49)))
   ...
   (assert (possible (row 6) (column 9) (value 7) (group 6) (id 54)))   


   (assert (possible (row 7) (column 1) (value any) (group 7) (id 55)))
   (assert (possible (row 7) (column 2) (value 1) (group 7) (id 56)))
   (assert (possible (row 7) (column 3) (value 9) (group 7) (id 57)))
   ...
   (assert (possible (row 7) (column 8) (value 3) (group 9) (id 74)))
   ...
   (assert (possible (row 8) (column 9) (value 8) (group 9) (id 78)))
