...
(defrule grid-values
   ...
   (assert (possible (row 3) (column 1) (value 1) (group 1) (id 7)))
   (assert (possible (row 3) (column 2) (value 9) (group 1) (id 8)))
   (assert (possible (row 3) (column 3) (value 2) (group 1) (id 9)))   

   (assert (possible (row 1) (column 4) (value 6) (group 2) (id 10)))
   (assert (possible (row 1) (column 5) (value 8) (group 2) (id 11)))
   ...
   (assert (possible (row 2) (column 6) (value 9) (group 2) (id 15)))
   ...
   (assert (possible (row 4) (column 2) (value 4) (group 4) (id 29)))
   ...
   (assert (possible (row 6) (column 3) (value 5) (group 4) (id 36)))   
   ...
   (assert (possible (row 5) (column 4) (value 3) (group 5) (id 40)))
   (assert (possible (row 5) (column 5) (value any) (group 5) (id 41)))
   (assert (possible (row 5) (column 6) (value 7) (group 5) (id 42)))
   ...
   (assert (possible (row 4) (column 7) (value 8) (group 6) (id 46)))
   ...
   (assert (possible (row 6) (column 8) (value 9) (group 6) (id 53)))
   ...
   (assert (possible (row 8) (column 3) (value 9) (group 7) (id 60)))
   ...
   (assert (possible (row 8) (column 4) (value 2) (group 8) (id 67)))
   ...
   (assert (possible (row 9) (column 5) (value 4) (group 8) (id 71)))
   (assert (possible (row 9) (column 6) (value 6) (group 8) (id 72)))

   (assert (possible (row 7) (column 7) (value 3) (group 9) (id 73)))
   (assert (possible (row 7) (column 8) (value 1) (group 9) (id 74)))
   ...
   (assert (possible (row 8) (column 9) (value 6) (group 9) (id 78)))
