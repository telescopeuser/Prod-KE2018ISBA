...
(defrule grid-values
   ...
   (assert (possible (row 2) (column 2) (value 6)   (group 1) (id 5)))
   (assert (possible (row 2) (column 3) (value 8)   (group 1) (id 6)))   
   (assert (possible (row 3) (column 1) (value 4)   (group 1) (id 7)))
   ...
   (assert (possible (row 1) (column 5) (value 2) (group 2) (id 11)))
   (assert (possible (row 1) (column 6) (value any) (group 2) (id 12)))
   (assert (possible (row 2) (column 4) (value 5) (group 2) (id 13)))
   (assert (possible (row 2) (column 5) (value any) (group 2) (id 14)))
   (assert (possible (row 2) (column 6) (value 7) (group 2) (id 15)))
   ...
   (assert (possible (row 6) (column 2) (value 4) (group 4) (id 35)))
   ...
   (assert (possible (row 4) (column 8) (value 2) (group 6) (id 47)))
   (assert (possible (row 4) (column 9) (value any) (group 6) (id 48)))
   (assert (possible (row 5) (column 7) (value any) (group 6) (id 49)))
   (assert (possible (row 5) (column 8) (value 7) (group 6) (id 50)))
   (assert (possible (row 5) (column 9) (value 3) (group 6) (id 51)))
   (assert (possible (row 6) (column 7) (value any) (group 6) (id 52)))
   (assert (possible (row 6) (column 8) (value any) (group 6) (id 53)))
   (assert (possible (row 6) (column 9) (value 9) (group 6) (id 54)))   


   (assert (possible (row 7) (column 1) (value any) (group 7) (id 55)))
   (assert (possible (row 7) (column 2) (value 2) (group 7) (id 56)))
   (assert (possible (row 7) (column 3) (value any) (group 7) (id 57)))
   (assert (possible (row 8) (column 1) (value 3) (group 7) (id 58)))
   (assert (possible (row 8) (column 2) (value 9) (group 7) (id 59)))
